	...
	<div class="contenderProductos">
		...
		<?php
	      ...
	      while ($fila = mysql_fetch_array($productos)){
					...
					echo "<div class='producto' style='background-image:url(img/". $fila['imagen'] . ")'>";
						echo "<div class='infoProducto'>";
							echo "<p class='contenidoProducto'>" . $fila['nombreProducto'] . "</p>";
							echo "<p class='contenidoProducto'>" . $fila['precioProducto'] . "</p>";
							echo "<p class='contenidoProducto'>" . $fila['concentracion'] . "</p>";
